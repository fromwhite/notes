export const triangle = (
  <svg
    ...
    width="24"
    // @ts-ignore
    style="color:var(--foreground);width:24px;height:24px"
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
